...
\begin{description}
    ...
    \item [Business Inteligence] Responsable de la reportabilidad de información crítica sobre uso de productos, ventas y facturación. Se diseñan y automatizan reportes en Tableau y se ejecutan estrategias de prevención de churn basadas en datos.
    \item [Machine Learning] Modelos de ML aplicado a productos de la empresa. Segmentación de clientes, automatización de acciones, recomendación de productos y predicción de comportamiento de clientes. Todos estos proyectos requieren desarrollar algoritmos de inteligencia artificial e implementarlos en servicios \textit{cloud}.
\end{description}
}
