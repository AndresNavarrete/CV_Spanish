...
\cventry{2022 - Actual}{Data Scientist}{\href{https://www.linkedin.com/company/dispatchtrack-es/}{Beetrack - DispatchTrack}}{}{}{   Responsable de la ingeniería y análisis de datos. Desarrollo soluciones tecnológicas orientadas a automatización de procesos y análisis de grandes volúmenes de información.
\begin{description}
...
\cventry{2021 - 2022}{Ingeniero de proyectos}{\href{https://www.linkedin.com/company/dispatchtrack-es/}{Beetrack - DispatchTrack}}{}{}{Desarrollador en el equipo de innovación de producto. Responsable de desarrollar  soluciones tecnológicas para aumentar el valor de los distintos productos de la empresa. Los principales proyectos fueron:
\begin{description}
\item [Diseño de algoritmos] Desarrollo de algoritmos para resolver dolores de la industria logística. (1) Desarrollamos un algoritmo de ruteo de flotas de vehículos de última milla. En este algoritmo se busca maximizar el nivel de servicio de los clientes buscando una reducción en los costos de la operación.  (2) Desarrollamos un algoritmo de gestión de inventarios para industrias de alta rotación de productos. El objetivo es minimizar los costos de almacenamiento de clientes con capacidad de inventarios y permitir una administración más eficiente de este recurso.
\item [Machine Learning] Desarrollamos un servicio predicativo de tiempos de viaje considerando tráfico y algoritmos de inteligencia artificial. Generamos un modelo que permite estimar los tiempos de la operación los clientes usando su data histórica y reducir la incertidumbre la gestión de la operación. 
\end{description}
}
